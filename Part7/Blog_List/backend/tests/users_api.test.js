...
const users = [
    {
        ...
        passwordHash:
            '$2b$10$6cm/SYVBrDSSQlTH3YYx3elYbYzW45G.dOwshMwYI0Sdt0eo2ehHS',
        name: 'Robert',
    },
    {
        username: 'luluMorton',
        ...
        passwordHash:
            '$2b$10$0QNg4/vO.GtzZ/v9v0PHJOEoDtCb.V1Jhv1Ad7AC1T5KjKyaXXRJe',
        name: 'Lulu',
    },
    {
        ...
        password: 'tyacm',
        passwordHash:
            '$2b$10$yyPlQ9ZwF/BMydCPYJ51Buq4Pg/UKsnut/PTtXYQe7y75aOM9cGP.',
        name: 'Erik',
    },
    {
        ...
        passwordHash:
            '$2b$10$jKeJQOxer5aK51aQ7dZ6OOKyw2Yr0JlvpLVQDVfo5W2PA.L8uoq2y',
        name: 'Warren',
    },
    {
        ...
        passwordHash:
            '$2b$10$BF4RhITkvbjNxVoMdF7Znu2XkXUJh3q0LQ4b8aIbdoBr/kUnl8x82',
        name: 'Bess',
    },
    {
        username: 'chadFoster',
        password: 'lrCnV8S',
        passwordHash:
            '$2b$10$DANAw56yxg.SRTZ7lkwXhe95H7iMSu1X1vInF6Zy3a7Rv4LX4DBA.',
        name: 'Chad',
    },
    {
        ...
        password: 'd3xjm',
        passwordHash:
            '$2b$10$TVj78J8i1YYs1QTLkbgIgueZK2lS5KNIFN4YNnkNQtP66otZY0eI2',
        name: 'Marian',
    },
    {
        ...
        password: 'g9Xr4mweAI',
        passwordHash:
            '$2b$10$t.hrrdCIhXE8m7PdVdPTJu1kTiR6uZhPAm3XUgFUVKeECJr85mLkK',
        name: 'Jordan',
    },
    {
        ...
        password: '8kG2sJ6',
        passwordHash:
            '$2b$10$JNe3BQu3T3giIOFXAS/gBO3W6cul3pRM66QURq6cJNdUvojmZxNG6',
        name: 'Emilie',
    },
    {
        ...
        passwordHash:
            '$2b$10$OAFZZdyNmvNSx8CELDOcO..bWhHltR2Dml4.u94Ikeq4MLnyABsm.',
        name: 'Jayden',
    },
]
